from dynamodb import delete_item, get_items_by_cart_id
...
def handler(event: dict, context: dict) -> dict:
    ...
    if cart_items[0].user_id != user_id:
        return create_response(400, "You don't have permission to delete this cart")

    for item in cart_items:
        delete_item(item.cart_id, item.variant_id)
